    ...
    MainmenuExe('0px','40px', true,false,`
        <div style="display:flex">
            ...
            <div style="display:flex; flex-direction:column; width:100%;">
                ...
                <hr>
                <button onmouseenter="Delete_MainmenusecExe()" style=bottom:0;> <img src=./Styles/appicons/shutdownnormal.ico style='height: 45px; margin:-6px'> <p class="disabled">ShutDown...</p></button>
            </div>
        </div>
        `);
}

let Programs_Menu = `<div> <button onclick=CmdEXE()> <img src=./Styles/appicons/msdos1.png> MS-DOS Prompt</button> <button class=disabled><img src=./Styles/icons/System/WindowsExplorer.ico>Windows Explorer</button> </div>`
